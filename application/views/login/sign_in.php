                            ...
                            <div class="text-box-cont">
                                <div class="input-group mb-3">
                                 ...
                                 <div class="input-group mb-3">
                                    ...
                                    <input type="password" class="form-control" id="password" name="password" placeholder="Password" aria-label="Username" aria-describedby="basic-addon1">
                                </div>
                                <div class="row">
...
<script src="<?php echo base_url(); ?>source/assets/js/popper.min.js"></script>
<script src="<?php echo base_url(); ?>source/assets/js/bootstrap.min.js"></script>
